...
class FormSubmit extends Event
{
    ...
    {
        return __('Form Submit', WPNE_NJF);
    }
    ...
    {
        $this->subject = __('Form "[form-name]" submit', WPNE_NJF);
        $this->message = __("Form \"[form-name]\" submit\n\n[form-all-fields]", WPNE_NJF);
    ...
    public function tag_labels($form = null)
    {
        ...
        return array_merge([
            __('Form', WPNE_NJF) => NinjaForms::labels($form),
        ], parent::tag_labels());
    }
